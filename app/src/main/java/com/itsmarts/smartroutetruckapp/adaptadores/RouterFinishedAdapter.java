...
public class RouterFinishedAdapter extends RecyclerView.Adapter<RouterFinishedAdapter.RouteViewHolder> {
    ...
    public RouterFinishedAdapter(MainActivity mainActivity) {
    ...
    public void onBindViewHolder(RouteViewHolder holder, int position) {
        ...
        if(mainActivity.rutas.get(position).status == 2 && id != mainActivity.rutas.get(position).id){
    ...
    public static class RouteViewHolder extends RecyclerView.ViewHolder {
        ...
        public RouteViewHolder(View itemView, RouterFinishedAdapter adapter) {
            super(itemView);
