...
import com.itsmarts.OverFleet.activitys.InicioSesionActivity;
import com.itsmarts.OverFleet.adaptadores.RouterAsignedAdapter;
import com.itsmarts.OverFleet.api.ApiService;
import com.itsmarts.OverFleet.api.RetrofitClient;
import com.itsmarts.OverFleet.bd.DatabaseHelper;
import com.itsmarts.OverFleet.clases.AnimatorNew;
import com.itsmarts.OverFleet.clases.AvoidZonesExample;
import com.itsmarts.OverFleet.clases.IncidenciasExample;
import com.itsmarts.OverFleet.clases.ControlPointsExample;
import com.itsmarts.OverFleet.clases.Logger;
import com.itsmarts.OverFleet.clases.NavigationEventHandler;
import com.itsmarts.OverFleet.clases.NavigationExample;
import com.itsmarts.OverFleet.clases.OfflineMap;
import com.itsmarts.OverFleet.clases.RoutingExample;
import com.itsmarts.OverFleet.clases.TruckConfig;
import com.itsmarts.OverFleet.clases.mapHelper;
import com.itsmarts.OverFleet.fragments.ErrorDialogFragment;
import com.itsmarts.OverFleet.fragments.ModalBottomSheetFullScreenFragmentIncidencias;
import com.itsmarts.OverFleet.fragments.ModalBottomSheetFullScreenFragmentPuntos;
import com.itsmarts.OverFleet.fragments.ModalBottomSheetFullScreenFragmentZonas;
import com.itsmarts.OverFleet.helpers.Geocercas;
import com.itsmarts.OverFleet.helpers.Internet;
import com.itsmarts.OverFleet.helpers.Messages;
import com.itsmarts.OverFleet.modelos.Incidencia;
import com.itsmarts.OverFleet.modelos.PointWithId;
import com.itsmarts.OverFleet.modelos.PolygonWithId;
import com.itsmarts.OverFleet.modelos.RoutesWithId;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, NavigationEventHandler.SpeedUpdateListener, NavigationEventHandler.DestinationDistanceListener, NavigationEventHandler.DestinationReachedListener{
        ...
        try{
            ...
            switch (title) {
                ...
                case "Perfil":
                    ...
                    String telefono_recogido = sharedPreferences.getString("telefono", "1234567890");
                    if(telefono_recogido.equals("null")){
                        telefono_recogido = "";
                    }
                    String telefono = telefono_recogido;
                        ...
                        public void onClick(View v) {
                            ...
                            btnActualizar1.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    if(!contraseniaEditText.getText().toString().equals("")){
                                        if(contraseniaEditText.getText().toString().length()>= 6){
                                            ...
                                            Toast.makeText(MainActivity.this, "La contraseña debe de tener 6 caracteres como minimo", Toast.LENGTH_SHORT).show();
                                        }
                                    }else{
    ...
    private void dispatchTakePictureIntent() {
        ...
        if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
            ...
            if (imageFile != null) {
                imageUri = FileProvider.getUriForFile(this, "com.itsmarts.OverFleet.fileprovider", imageFile); // Tu autoridad de FileProvider
