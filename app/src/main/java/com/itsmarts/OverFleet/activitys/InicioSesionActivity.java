package com.itsmarts.OverFleet.activitys;
...
import com.itsmarts.OverFleet.MainActivity;
import com.itsmarts.OverFleet.R;
import com.itsmarts.OverFleet.api.ApiService;
import com.itsmarts.OverFleet.api.RetrofitClient;
import com.itsmarts.OverFleet.clases.CredentialsManager;
...
import com.itsmarts.OverFleet.modelos.LoginRequest;
import com.itsmarts.OverFleet.modelos.RecuperarContraseniaRequest;
...
public class InicioSesionActivity extends AppCompatActivity {
                                        ...
                                        if(!lastVersion.equalsIgnoreCase(getApplicationContext().getPackageManager().getPackageInfo(getApplicationContext().getPackageName(), 0).versionName)){
                                            ...
                                            btnActualizar.setOnClickListener(new View.OnClickListener() {
                                                ...
                                                public void onClick(View v) {
                                                    ...
                                                    String packageName = "com.itsmarts.OverFleet";
                                                    try {
    ...
    private boolean isValidEmail(String email) {
        ...
        try{
            ...
            isValid = email.matches(emailPattern) || email.matches(emailPatternMX);
        }catch(Exception e){
            logger.logError(TAG,e,InicioSesionActivity.this);
        }
        return isValid;
